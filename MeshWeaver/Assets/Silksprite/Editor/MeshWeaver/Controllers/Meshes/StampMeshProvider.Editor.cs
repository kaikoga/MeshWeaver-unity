...
namespace Silksprite.MeshWeaver.Controllers.Meshes
{
    ...
    public class StampMeshProviderEditor : MeshProviderEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            MeshBuilderGUI.DumpFoldout("Mesh data", ref _isExpandedMesh, () => stampMeshProvider.LastMeshie.Build(GuessCurrentLodMaskLayer()));
            MeshBuilderGUI.DumpFoldout("Path data", ref _isExpandedPath, () => stampMeshProvider.LastPathie.Build(GuessCurrentLodMaskLayer()));
        }
    }
}